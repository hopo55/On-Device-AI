...
dataset = file_path + '/'
save_dir = 'InnoHAR_TF/save/' + device + '/' + user_type
...
# Base Model
model = InnoHAR(class_num, segment_size)
...
model_head = InnoHAR(class_num, segment_size, include_top=False)
...
head = SoftmaxClassifierHead(batch_size, (128), class_num)
