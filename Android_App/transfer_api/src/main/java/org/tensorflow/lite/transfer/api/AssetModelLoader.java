...
public class AssetModelLoader implements org.tensorflow.lite.transfer.api.ModelLoader {
  ...
  public LiteModelWrapper loadInitializeModel() throws IOException {
    return new LiteModelWrapper(loadMappedFile("model_init.tflite"));
  }

  @Override
  public LiteModelWrapper loadInferenceModel() throws IOException {
    return new LiteModelWrapper(loadMappedFile("model_base.tflite"));
  }

  @Override
  public LiteModelWrapper loadTrainModel() throws IOException {
    return new LiteModelWrapper(loadMappedFile("model_train.tflite"));
  }

  @Override
  public LiteModelWrapper loadBaseModel() throws IOException {
    return new LiteModelWrapper(loadMappedFile("model_head.tflite"));
  }

  @Override
  public LiteModelWrapper loadInferenceTrainModel() throws IOException {
    return new LiteModelWrapper(loadMappedFile("model_fc.tflite"));
  }
